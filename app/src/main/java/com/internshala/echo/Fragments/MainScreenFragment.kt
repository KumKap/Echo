...
class MainScreenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        nowPlayingBottomBar = view?.findViewById<RelativeLayout>(R.id.hiddneBarMainScreen)
        songTitle = view?.findViewById<TextView>(R.id.textView)
    ...
    fun bottomBarClickHandler() {
        nowPlayingBottomBar?.setOnClickListener({
            ...
            args.putString("songTitle", SongPlayingFragment.Statified.currentSongHelper?.songPath)
            args.putString("path", SongPlayingFragment.Statified.currentSongHelper?.songTitle)
            args.putInt("songPosition", SongPlayingFragment.Statified.currentSongHelper?.songId?.toInt() as Int)
            args.putInt("songID", SongPlayingFragment.Statified.currentSongHelper?.currentPosition?.toInt() as Int)
